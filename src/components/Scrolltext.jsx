...
const Scrolltext = () => {
  ...
  return (
    <div ref={scrollRef} className="text-white w-full md:px-20 px-6 ">
      <h1
        id="maintext"
        className="w-full text-center text-4xl  sm:text-5xl md:text-6xl lg:text-6xl xl:text-8xl tracking-wide font-[Akira] leading-tight lg:mb-0 mb-8 "
      >
        Want's to know more!
      </h1>
      <div className="w-full h-full flex lg:flex-row md:flex-col flex-col gap-2 md:flex-wrap  ">
        <div className="flex items-center justify-center flex-col w-full h-auto flex-1 gap-6 md:gap-10 ">
          <p
            ref={pararef}
            className="text-sm sm:text-base md:text-lg lg:text-[1vw] font-[Galano] leading-relaxed"
          >
          ...
          <p className="paratext text-sm sm:text-base md:text-lg lg:text-[1vw] font-[Galano] ">
