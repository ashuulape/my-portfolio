...
const techLogos = [
  ...
  {
    node: <SiRefinedgithub color="#ffffff" />,
    title: "GitHub",
  ...
  {
    node: <SiCss color="#663399" />,
    title: "CSS",
    href: "https://developer.mozilla.org/en-US/docs/Web/CSS",
  },
  {
    node: <SiNodedotjs color="#5FA04E" />,
    title: "Node.js",
...
export function LogoSlide() {
  return (
    <div className="h-fit relative overflow-hidden">
      ...
      <h2 className="w=full text-center m-2">SKILLS & TOOLS</h2>
      <LogoLoop
        logos={techLogos}
        speed={120}
        direction="left"
