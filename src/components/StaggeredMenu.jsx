...
export const StaggeredMenu = ({
  ...
  return (
    <div
      className={`sm-scope pointer-events-none z-100 fixed ${isFixed ? "fixed top-0 left-0 w-screen h-full overflow-hidden" : "w-full h-full"}`}
    >
      <div
        className={
          (className ? className + " " : "") +
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel w-fit absolute top-0 right-0 h-full bg-white flex flex-col md:p-[6em_0.5em_2em_0.5em] p-[6em_2em_2em_2em]  overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto"
                ...
                items.map((it, idx) => (
                  ...
                  >
                    <a
                      ...
                      onClick={() => {
                        transitionfun(it.link, it.label);
                      }}
...
.sm-scope .sm-toggle { position: relative; display: inline-flex; align-items: center; gap: 0.3rem; background:#7463F84D;padding:8px 8px 8px 16px;border:solid 1px #7463F8; border-radius:10px; cursor: pointer; color: #e9e9ef; font-weight: 500; line-height: 1; overflow: visible; }
.sm-scope .sm-toggle:focus-visible { outline: 2px solid #7463F8; outline-offset: 4px; border-radius: 4px; }
...
.sm-scope .sm-icon-line { position: absolute; left: 50%; top: 50%; width: 100%; height: 2px; background: currentColor; transform: translate(-50%, -50%); will-change: transform; }
...
.sm-scope .sm-socials-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: row; align-items: start; gap: 1rem; flex-wrap: wrap; }
