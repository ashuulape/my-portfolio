...
const OptionWheel = ({
  ...
  return (
    <div
      ...
      className={`absolute h-full w-full select-none overflow-hidden outline-none [touch-action:none] ${isDragging ? "cursor-grabbing" : "cursor-grab"}${className ? ` ${className}` : ""}`}
      style={{
